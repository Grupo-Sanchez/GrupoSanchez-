...
export default class Devoluciones extends Component {
  ...
  write = async () => {
    ...
    await axios.post('http://178.128.67.247:3001:3001/api/devoluciones', campos);
  ...
  getProductos = async () => {
    await axios
      .get('http://178.128.67.247:3001:3001/api/productos')
      .then((response) => {
  ...
  updateTool = async (id) => {
    ...
    axios.put(`http://178.128.67.247:3001:3001/api/productos/${id}`, { cantidad: cantidad2 });
  };
  eliminarProducto = async (i, cantidad) => {
    ...
    axios.put(`http://178.128.67.247:3001:3001/api/productos/${i}`, { cantidad: cantidad2 });
