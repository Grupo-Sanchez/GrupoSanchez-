                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          ...
                          (e.next = 3),
                          D.a.post('http://178.128.67.247/api/productos', t)
                        );
                      case 3:
      ...
      function G(e) {
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (e.next = 2),
                          D.a.get('http://178.128.67.247/api/productos').then(function (e) {
                            $(e.data);
                          })
                        );
                      case 2:
        ...
        var ne = function (e) {
            ...
            $(
              ...
              (t = e),
              D.a.delete('http://178.128.67.247/api/productos/'.concat(t));
          },
                        ...
                        Object(a.jsx)('button', {
                          ...
                          onClick: function () {
                            return (
                              ...
                              N(!1),
                              void D.a
                                .put('http://178.128.67.247/api/productos/'.concat(e), {
                        ...
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              ...
                              (e.next = 3),
                              D.a.post('http://178.128.67.247/api/clientes', t)
                            );
                          case 3:
                      ...
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            ...
                            return (
                              (t.next = 4),
                              D.a.delete('http://178.128.67.247/api/clientes/'.concat(c))
                            );
                          case 4:
                ...
                w.a.mark(function t() {
                  ...
                  return w.a.wrap(function (t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (t.next = 2), D.a.get('http://178.128.67.247/api/clientes');
                        case 2:
                        ...
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              ...
                              (e.next = 3),
                              D.a.post('http://178.128.67.247/api/devoluciones', t)
                            );
                          case 3:
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 7:
                              ...
                              break;
                            case 10:
                              D.a.put('http://178.128.67.247/api/productos/'.concat(t), {
                                cantidad: c,
                              });
                            case 11:
                            case 'end':
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            ...
                            (e.next = 4),
                            D.a.post('http://178.128.67.247/api/facturas', t)
                          );
                        case 4:
                          window.location.reload();
                        case 5:
